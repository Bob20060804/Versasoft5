...
{
	public class EDC_MesMaschinenDatenArgumenteAttribut : Attribute
	{
		...
		internal EDC_MesMaschinenDatenArgumenteAttribut(ENUM_MesFunktionen i_enmMesFunktion, Type i_objTyp, string i_strBezeichner)
		{
